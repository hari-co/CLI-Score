...
async function getSuffix(url: string): Promise<string | undefined> {
    ...
    const matches = links
        ...
        .filter(href => href && href.startsWith("https://musescore.com/static/public/build/musescore_es6/")) as string[];
...
function getApiEndpoint(id: string, index: string, type: string): string {
